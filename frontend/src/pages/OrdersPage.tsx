    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="flex items-center px-6 py-4 border-b border-gray-100 animate-pulse">
              <div className="h-4 bg-gray-200 rounded w-1/6 mr-4" />
              <div className="h-4 bg-gray-200 rounded w-1/4 mr-4" />
              <div className="h-4 bg-gray-200 rounded w-1/6 mr-4" />
              <div className="h-6 bg-gray-100 rounded-full w-16 mr-4" />
